...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, kalkulyator botimizga hush kelibsiz\n/calc komandasidan foydalaning!")
    except:
...
async def about_commands(message:Message):
    await message.answer("uzm haqimda ma'lumot yo'q 😁")
